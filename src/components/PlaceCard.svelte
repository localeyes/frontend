...
<div class="card bg-base-100 shadow-lg hover:shadow-2xl w-full h-full">
	...
	<div class="stats shadow">
		...
		<div class="stat">
		  ...
		  <div class="stat-desc">{Math.floor(Math.random() * 7) + 1}% higher than last month</div>
		</div>
		...
		<div class="stat">
		  ...
		  <div class="stat-desc">{Math.floor(Math.random() * 7) + 1}% more than last month</div>
		</div>
		...
		<div class="stat">
		  ...
		  <div class="stat-value">{Math.floor(Math.random() * 4) * 5 + 5}% Off</div>
		  <div class="stat-title">Coupon</div>
		  <div class="stat-desc text-secondary">{Math.floor(Math.random() * 50) + 1} coupons remaining</div>
		</div>
	  </div>
